...
import { getMonthAndYear, getTime, calculateDuration } from '../utils';
...
function createTripPointTemplate(tripPoint) {
  ...
  const startDate = getMonthAndYear(startDateTime);
  const endTime = getTime(endDateTime);
  const endDate = getMonthAndYear(endDateTime);
  ...
  return `<li class="trip-events__item">
            <div class="event">
              ...
              <div class="event__type">
                <img class="event__type-icon" width="42" height="42" src="img/icons/${transport.toLowerCase()}.png" alt="Event type icon">
              </div>
              <h3 class="event__title">${transport} ${destination.city} </h3>
